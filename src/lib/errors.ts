...
const ERROR_TRANSLATIONS: Record<string, LocalizedError> = {
  ...
  "Request not found.": { rw: "Ubusabe ntibwabonetse.", fr: "Demande introuvable." },
  "Service not found.": { rw: "Serivisi ntiyabonetse.", fr: "Service introuvable." },
  ...
  "This service is no longer available.": { rw: "Iyi serivisi ntikiboneka.", fr: "Ce service n’est plus disponible." },
  "This request is already closed.": { rw: "Ubu busabe bwarafunzwe.", fr: "Cette demande est déjà clôturée." },
  "You already have an open request for this service.": { rw: "Usanzwe ufite ubusabe budafunze kuri iyi serivisi.", fr: "Vous avez déjà une demande en cours pour ce service." },
  ...
  "Not your request.": { rw: "Si ubusabe bwawe.", fr: "Ce n’est pas votre demande." },
  "You cannot set that status.": { rw: "Ntushobora gushyiraho uwo mimerere.", fr: "Vous ne pouvez pas définir ce statut." },
  ...
  "Enter a valid image URL.": { rw: "Andika aderesi (URL) y'ifoto yemewe.", fr: "Saisissez une URL d'image valide." },
  "Only http(s) image URLs are allowed.": { rw: "Hemewe gusa aderesi za http(s).", fr: "Seules les URL http(s) sont autorisées." },
  "That address is not allowed.": { rw: "Iyo aderesi ntiyemewe.", fr: "Cette adresse n'est pas autorisée." },
  "Couldn't fetch that image URL.": { rw: "Ntibishoboye gukurura iyo foto.", fr: "Impossible de récupérer cette image." },
  ...
  "You cannot request your own service.": { rw: "Ntushobora gusaba serivisi yawe bwite.", fr: "Vous ne pouvez pas demander votre propre service." },
  "This listing is not a service.": { rw: "Iki cyatanzwe si serivisi.", fr: "Cette annonce n’est pas un service." },
